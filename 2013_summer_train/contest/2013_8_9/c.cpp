...
int main(){
    ll n;while(~scanf("%I64d",&n)){
        ...
        for(ll i=0;i<n;i++) scanf("%I64d",&ans1[0][i]);
        ll m;scanf("%I64d",&m);
//        printf("%d!!!!\n",m);
        for(ll i=0;i<m;i++){
            ...
            if(str[0]=='r'){
                ...
                o[i][0]=3;scanf("%I64d%I64d",&o[i][1],&o[i][2]);
            }
            else if(str[0]=='s'){
                o[i][0]=4;scanf("%I64d%I64d",&o[i][1],&o[i][2]);
            }
            else if(str[0]=='i'){
                o[i][0]=5;scanf("%I64d%I64d",&o[i][1],&o[i][2]);
            }
            else if(str[0]=='t'){
                o[i][0]=6;scanf("%I64d%I64d%I64d%I64d",&o[i][1],&o[i][2],&o[i][3],&o[i][4]);
            }
        }
//        puts("@@@@@@@@@@@@@@@@@@@@@\n");
        ll p;scanf("%I64d",&p);
...
//        }
        ans1=mul(ans1,tr,1,n,n);
        for(ll i=0;i<n;i++){
            if(i)printf(" %I64d",ans1[0][i]%N);
            else printf("%I64d",ans1[0][i]%N);
        }
        puts("");
    }
    return 0;
