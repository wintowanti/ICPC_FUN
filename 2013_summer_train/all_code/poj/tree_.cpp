...
struct T{
    ...
    void push_down(int rt,int num,int l){
        ...
        if(e[rt].lazy==0){
            ...
            e[rson].lmax=e[rson].tmax=e[rson].rmax=t2;e[rson].lflag=e[rson].rflag=e[rson].tflag=l+num;
        }
        else if(e[rt].lazy==1){
            e[lson].lazy=e[rson].lazy=1;
            e[lson].lmax=e[lson].tmax=e[lson].rmax=0;e[lson].lflag=e[lson].rflag=e[lson].tflag=l;
            e[rson].lmax=e[rson].tmax=e[rson].rmax=0;e[rson].lflag=e[rson].rflag=e[rson].tflag=l+num;
        }
        e[rt].lazy=-1;
    }
    void build(int l,int r,int rt){
        ...
        int num=(r-l+1);
        if(l==r){
            e[rt].lmax=e[rt].rmax=e[rt].tmax=1;e[rt].lflag=e[rt].rflag=e[rt].tflag=l;
            return ;
        }
        int mid=(l+r)>>1;
        build(l,mid,lson);
